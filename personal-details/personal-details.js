...
function generateName() {
    ...
    document.getElementById("name").innerHTML = generatedFirstName + " " + generatedSurname;
    // ! Matter Number
...
function generateAddress() {
    ...
    document.getElementById("address").innerHTML = generatedNumber + " " + streetPrefix[generatedStreetPrefix] + " " + streetName[generatedStreetName] + ", " + town[generatedTown] + ", " + fullPostcode;
}
...
//     document.getElementById("sortCode").innerHTML = sortcode1;
// }
...
function generateSortCode() {
    ...
    document.getElementById("sortCode").innerHTML = sortcode3;
}

// function formatSortCode(str) {
//     let sortCode2 = (String(str).match(/.{1,2}/g) || []).join('-');
//     console.log(sortCode2)
//     return sortCode2;
// }

// formatSortCode(sortCode1);
...
function generateAccountNumber() {
    ...
    document.getElementById("accountNumber").innerHTML = accountnumber1 + " " + accountnumber2;
}
...
function generateBank() {
    ...
    document.getElementById("bank").innerHTML = generatedBank;
}
...
function generateIban() {
    ...
    document.getElementById("iban").innerHTML = countryCode + checkDigits + generatedBankCode + sortCode + accountNumber;
}
...
function generateSwift() {
    ...
    document.getElementById("swiftCode").innerHTML = bankCode + countryCode + locationCode + branchCode;
}
...
//     let sortcode2 = generateNumber(6);
//     let sortcode3 = formatSortCode(sortcode2);
//     document.getElementById("sortCode1").innerHTML = sortcode3;
// }